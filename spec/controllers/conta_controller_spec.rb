  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created contum" do
        post :create, {:contum => valid_attributes}, valid_session
        expect(response).to redirect_to(Contum.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:contum => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested contum" do
        contum = Contum.create! valid_attributes
        put :update, {:id => contum.to_param, :contum => new_attributes}, valid_session
        contum.reload
      ...
      it "redirects to the contum" do
        ...
        expect(response).to redirect_to(contum)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        contum = Contum.create! valid_attributes
        put :update, {:id => contum.to_param, :contum => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
